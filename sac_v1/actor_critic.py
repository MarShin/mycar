...
class Agent:
    ...
    def update_network_parameters(self, tau=None):
        ...
        # spinningup here use .copy_ of the tensor obj i think
    ...
    def learn(self):
        ...
        # backprop value network - no use in v2
        # actions aka action here
        ...
        # backprop actor network - action sampled from the current policy
